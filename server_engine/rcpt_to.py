...
import sys
from server_engine.exceptions import (RcptToCmdException,
                        WhitespaceException,
                        PathException,
                        MailboxException,
                        StringException,
...
def rcpt_to_cmd(expected_char: str, second_t: bool = False) -> None:
    """
